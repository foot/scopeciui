...
var or__6455__auto__ = reagent.impl.template.named_QMARK_(x);
...
var or__6455__auto__ = reagent.impl.template.hiccup_tag_QMARK_(x);
if(cljs.core.truth_(or__6455__auto__)){
return or__6455__auto__;
} else {
...
var G__17173 = o;
(G__17173[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
var old_17177 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_17177))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_17177)].join(''):class$));
} else {
}
...
if(cljs.core.not((function (){var and__6443__auto__ = (node === document.activeElement);
if(and__6443__auto__){
var and__6443__auto____$1 = reagent.impl.template.has_selection_api_QMARK_((node["type"]));
...
if(cljs.core.truth_((function (){var and__6443__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__17180 = jsprops;
(G__17180["defaultValue"] = value);

(G__17180["onChange"] = ((function (G__17180,v,value,on_change){
return (function (p1__17178_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__17178_SHARP_);
});})(G__17180,v,value,on_change))
);
...
var vec__17182 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17182,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17182,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17182,(2),null);
...
var temp__4427__auto__ = (function (){var G__17186 = cljs.core.meta(v);
var G__17186__$1 = (((G__17186 == null))?null:reagent.impl.template.get_key(G__17186));
return G__17186__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__17188_17189 = v;
var G__17188_17190__$1 = (((G__17188_17189 == null))?null:reagent.impl.template.key_from_vec(G__17188_17189));
var G__17188_17191__$2 = (((G__17188_17190__$1 == null))?null:(jsprops["key"] = G__17188_17190__$1));
...
var G__17195 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__17195) : reagent.impl.template.as_element.call(null,G__17195));
} else {
var p = (function (){var temp__4427__auto__ = (function (){var G__17196 = cljs.core.meta(argv);
var G__17196__$1 = (((G__17196 == null))?null:reagent.impl.template.get_key(G__17196));
return G__17196__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__17197 = (((jsprops == null))?{}:jsprops);
(G__17197["key"] = key);
...
var G__17198 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__17198;
continue;
}
} else {
...
var n__7358__auto___17199 = a.length;
var i_17200 = (0);
while(true){
if((i_17200 < n__7358__auto___17199)){
(a[i_17200] = reagent.impl.template.as_element((a[i_17200])));

var G__17201 = (i_17200 + (1));
i_17200 = G__17201;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7358__auto___17202 = a.length;
var i_17203 = (0);
while(true){
if((i_17203 < n__7358__auto___17202)){
var val_17204 = (a[i_17203]);
if((cljs.core.vector_QMARK_(val_17204)) && ((reagent.impl.template.key_from_vec(val_17204) == null))){
(o["no-key"] = true);
} else {
}

(a[i_17203] = reagent.impl.template.as_element(val_17204));

var G__17205 = (i_17203 + (1));
i_17203 = G__17205;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__6443__auto__ = cljs.core.not(reagent.impl.component._STAR_non_reactive_STAR_);
if(and__6443__auto__){
return (ctx["no-key"]);
} else {
return and__6443__auto__;
...
var G__17207 = (cljs.core.count(argv) - first_child);
switch (G__17207) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__17207){
